...
class BSTest:
	...
	def runTest2(self):
		...
		self.send(1, '{"gid":"###", "cmd":"m", "arg":{ "shot": [1, 0] } }')
		self.send(1, '{"gid":"###", "cmd":"m", "arg":{ "shot": [1, 1] } }')
		self.send(2, '{"gid":"###", "cmd":"m", "arg":{ "shot": [2, 3], "hit": 1} }')
		self.send(1, '{"gid":"###", "cmd":"m", "arg":{ "shot": [3, 4] } }')
		self.send(2, '{"gid":"###", "cmd":"m", "arg":{ "shot": [0, 1], "hit": 0} }')
		self.send(1, '{"gid":"###", "cmd":"m", "arg":{ "shot": [3, 2], "hit": 0} }')
		self.send(2, '{"gid":"###", "cmd":"m", "arg":{ "shot": [0, 2], "hit": 0} }')
		self.send(1, '{"gid":"###", "cmd":"m", "arg":{ "shot": [4, 5], "hit": 1} }')
